...
void SPI_Init(SPI_TypeDef *SPIx, SPI_InitTypeDef *SPI_InitStruct)
{
...
#endif
    {
        ...
        SPI_M_SER_t spi_0x10 = {.d32 = SPIx->SPI_M_SER};
        spi_0x10.b.ser = 1;
        ...
        else
        {
            if (SPIx == SPI1)
            {
                ...
                SPI_WRAP_CTRL_t spi_0x200 = {.d32 = SPIx->SPI_WRAP_CTRL};
                ...
                if (SPI_InitStruct->SPI_TXWaperModeEn)
                {
                    ...
                    SPI_WRAP_CTRL_t spi_0x200 = {.d32 = SPIx->SPI_WRAP_CTRL};
                    SPI_WRAP_TXFTLR_t spi_0x204 = {.d32 = SPIx->SPI_WRAP_TXFTLR};
                    ...
                    if (SPI_InitStruct->SPI_TXWaperModeDmaEn)
                    {
                        ...
                        SPI_WRAP_DMACR_t spi_0x220 = {.d32 = SPIx->SPI_WRAP_DMACR};
                        SPI_WRAP_DMATDLR_t spi_0x224 = {.d32 = SPIx->SPI_WRAP_DMATDLR};
    ...
    else if (SPIx == SPI0_SLAVE)
    {
        ...
        SPI_S_CTRL0_t spi_0x00 = {.d32 = SPIx->SPI_M_S_CTRL0};
        spi_0x00.b.scph = SPI_InitStruct->SPI_CPHA;
        spi_0x00.b.scpol = SPI_InitStruct->SPI_CPOL;
    ...
    SPI_DMATDLR_t spi_0x50 = {.d32 = SPIx->SPI_DMATDLR};
    SPI_DMARDLR_t spi_0x54 = {.d32 = SPIx->SPI_DMARDLR};
