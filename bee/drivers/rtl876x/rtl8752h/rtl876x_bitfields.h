...
/* Bit 12 : BIT_SOC_UART0_EN. 1: enable log UART; 0: disable log UART */
#define SYSBLK_UART0_EN_Pos (12UL) /*!< Position of . */
...
#define SYSBLK_UART2_EN_Msk (0x1UL << SYSBLK_UART2_EN_Pos) /*!< Bit mask of  */

/* Bit 0 : BIT_PERI_UART0_EN. 1; enable UART0 interface ( DATA Uart) */
#define SYSBLK_UART1_EN_Pos (0UL) /*!< Position of . */
...
/* Bit 13 : BIT_SOC_SLPCK_UART0_EN */
#define SYSBLK_SLPCK_UART0_EN_Pos (13UL) /*!< Position of  */
#define SYSBLK_SLPCK_UART0_EN_Msk (0x1UL << SYSBLK_SLPCK_UART0_EN_Pos) /*!< Bit mask of  */

/* Bit 12 : BIT_SOC_ACTCK_UART0_EN */
#define SYSBLK_ACTCK_UART0_EN_Pos (12UL) /*!< Position of  */
#define SYSBLK_ACTCK_UART0_EN_Msk (0x1UL << SYSBLK_ACTCK_UART0_EN_Pos) /*!< Bit mask of  */

/* Bit 11 : BIT_SOC_SLPCK_UART2_EN */
#define SYSBLK_SLPCK_UART2_EN_Pos (11UL) /*!< Position of  */
#define SYSBLK_SLPCK_UART2_EN_Msk (0x1UL << SYSBLK_SLPCK_UART2_EN_Pos) /*!< Bit mask of  */

/* Bit 10 : BIT_SOC_ACTCK_UART2_EN */
#define SYSBLK_ACTCK_UART2_EN_Pos (10UL) /*!< Position of  */
#define SYSBLK_ACTCK_UART2_EN_Msk (0x1UL << SYSBLK_ACTCK_UART2_EN_Pos) /*!< Bit mask of  */
...
/* Bit 1 : BIT_SOC_SLPCK_UART1_DATA_EN */
#define SYSBLK_SLPCK_UART1_EN_Pos (1UL) /*!< Position of  */
#define SYSBLK_SLPCK_UART1_EN_Msk (0x1UL << SYSBLK_SLPCK_UART1_EN_Pos) /*!< Bit mask of  */

/* Bit 0 : BIT_SOC_ACTCK_UART1_DATA_EN */
#define SYSBLK_ACTCK_UART1_EN_Pos (0UL) /*!< Position of  */
#define SYSBLK_ACTCK_UART1_EN_Msk (0x1UL << SYSBLK_ACTCK_UART1_EN_Pos) /*!< Bit mask of  */
