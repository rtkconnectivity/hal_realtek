...
#define MAX_PIN_REG_NUM         (TOTAL_PIN_NUM/4+1)//pinmux num:21
 ...
 *
 * \param[in] Pin_Func: AON IO function, please refer to rtl876x_pinmux.h "PAD_Aon_Mux" part.
 *
 * \return None
 *
 * <b>Example usage</b>
...
/**
 * \brief  Config pin to its corresponding AON IO function.
 *
 * \param[in] Pin_Func: HS IO function, please refer to rtl876x_pinmux.h "PAD_HS_Mux" part.
 *
 * \return None
 *
 * <b>Example usage</b>
...
extern void Pad_ConfigExt(uint8_t Pin_Num,
                          ...
                          PAD_OUTPUT_ENABLE_Mode AON_PAD_E,
                          PAD_OUTPUT_VAL AON_PAD_O,
                          PAD_Pull_Strength_Mode AON_PAD_P);
#endif
