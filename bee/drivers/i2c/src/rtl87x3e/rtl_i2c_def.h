...
*********************************************************************************************************
* \file     rtl_i2c_def.h
* \brief    ADC related definitions for RTL87x3E
* \details
* \author
* \date     2023-11-15
* \version  v1.1
...
#define I2C_RX_FIFO_SIZE                               (40)
#define I2C_CLOCK_MAX_SPEED                            (400000)
...
/* 0x00
    ...
    31:9    R      reserved_dummy00_31_9   23'h0
*/
typedef union
{
    uint32_t d32;
