...
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *I2C_InitStruct)
{
    ...
    IC_ENABLE_t i2c_0x6c = {.d32 = I2Cx->IC_ENABLE};
    ...
    if (I2C_DeviveMode_Master == I2C_InitStruct->I2C_DeviveMode)
    {
        ...
        IC_CON_t i2c_0x00 = {.d32 = I2Cx->IC_CON};
        ...
        /* Set target address */
        IC_TAR_t i2c_0x04 = {.d32 = I2Cx->IC_TAR};
    ...
    else
    {
        ...
        IC_ACK_GENERAL_CALL_t i2c_0x98 = {.d32 = I2Cx->IC_ACK_GENERAL_CALL};
        i2c_0x98.b.ack_gen_call &= I2C_InitStruct->I2C_Ack;
        I2Cx->IC_ACK_GENERAL_CALL = i2c_0x98.d32;

        /* Set slave address */
        IC_SAR_t i2c_0x08 = {.d32 = I2Cx->IC_SAR};
        ...
        IC_SDA_SETUP_t i2c_0x94 = {.d32 = I2Cx->IC_SDA_SETUP};
    ...
    /* Config I2C dma mode */
    IC_DMA_CR_t i2c_0x88 = {.d32 = I2Cx->IC_DMA_CR};
    ...
    IC_DMA_TDLR_t i2c_0x8c = {.d32 = I2Cx->IC_DMA_TDLR};
    IC_DMA_RDLR_t i2c_0x90 = {.d32 = I2Cx->IC_DMA_RDLR};
                 ...
                 FunctionalState StopState)
{
    ...
    IC_DATA_CMD_t i2c_0x10 = {.d32 = I2Cx->IC_DATA_CMD};
    i2c_0x10.d32 = 0;
...
void I2C_SetClockSpeed(I2C_TypeDef *I2Cx, uint32_t I2C_ClockSpeed)
{
    ...
    IC_CON_t i2c_0x00 = {.d32 = I2Cx->IC_CON};
    IC_SS_SCL_HCNT_t i2c_0x14 = {.d32 = I2Cx->IC_SS_SCL_HCNT};
    IC_SS_SCL_LCNT_t i2c_0x18 = {.d32 = I2Cx->IC_SS_SCL_LCNT};
    IC_FS_SCL_HCNT_t i2c_0x1c = {.d32 = I2Cx->IC_FS_SCL_HCNT};
    IC_FS_SCL_LCNT_t i2c_0x20 = {.d32 = I2Cx->IC_FS_SCL_LCNT};
    IC_FS_SPKLEN_t i2c_0xa0 = {.d32 = I2Cx->IC_FS_SPKLEN};
