 ...
 *            \arg ENABLE: Enable the specified I2C peripheral.
 *            \arg DISABLE: Disable the specified I2C peripheral.
 *
 * \return None.
 *
 * <b>Example usage</b>
 ...
 *     I2C_MasterReadDevice(I2C0, &reg_addr, 1, data, 10);
 * }
 * \endcode
 */
 ...
 * \param[in] Writelen: Data length to send.
 * \param[in] pReadBuf: Data buffer to receive.
 * \param[in] Readlen: Data length to receive.
 *
 * \return I2C status, please refer to \ref I2C_Status.
 * \retval I2C_Success: I2C success.
 * \retval I2C_ARB_LOST: Master or slave transmitter losed arbitration.
 ...
 * \param[in] I2C_IT: Secified the I2C interrupt sources.
 *            This parameter can be one of the following values:
 ...
 *            \arg I2C_INT_TX_ABRT:   This bit indicates if I2C as an I2C transmitter, it is unable to complete the
 ...
 *            \arg I2C_INT_RX_FULL:   Set when the receive buffer reaches or goes above the RX_TL threshold in the IC_RX_TL register.
 ...
 *            This parameter can be one of the following values:
 *            \arg ENABLE: Mask the specified I2C interrupt.
 *            \arg DISABLE: Unmask the specified I2C interrupt.
 *
 * \return  None.
 *
 * <b>Example usage</b>
 ...
 *            \arg I2C_READ_CMD: Read command. Data which want to receive can be 0 in this situation.
 *            \arg I2C_WRITE_CMD: Write command. Data which want to transmit can be 1 in this situation.
 ...
 *            \arg I2C_FLAG_RFF: Receive FIFO is completely full.
 *            \arg I2C_FLAG_RFNE: Receive FIFO is not empty.
 *            \arg I2C_FLAG_TFE: Transmit FIFO is completely empty.
 *            \arg I2C_FLAG_TFNF: Transmit FIFO is not full.
