...
typedef struct
{
    ...
    uint32_t GDMA_RSVD2;                    /*!< 0x48 */
    __IO uint32_t GDMA_SGR;                 /*!< 0x4C */
    uint32_t GDMA_RSVD3;                    /*!< 0x50 */
...
#define GDMA_Handshake_RTZIP_RX             (27)
#define GDMA_Handshake_RTZIP_TX             (28)
...
#define IS_GDMA_TransferType(Type) (((Type) == GDMA_Handshake_UART0_TX)     || \
                                    ...
                                    ((Type) == GDMA_Handshake_RTZIP_RX)     || \
                                    ((Type) == GDMA_Handshake_RTZIP_TX)     || \
