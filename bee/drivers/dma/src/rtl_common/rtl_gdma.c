...
void GDMA_Init(GDMA_ChannelTypeDef *GDMA_Channelx, GDMA_InitTypeDef *GDMA_InitStruct)
{
    ...
    GDMA_CTL_LOWx_t gdma_0x18 = {.d32 = GDMA_Channelx->GDMA_CTL_LOWx};
    ...
    GDMA_CFG_LOWx_t gdma_0x40 = {.d32 = GDMA_Channelx->GDMA_CFG_LOWx};
    ...
    /* Set for secure mode */
    GDMA_CFG_HIGHx_t gdma_0x44 = {.d32 = GDMA_Channelx->GDMA_CFG_HIGHx};
...
void GDMA_SetOSW(uint8_t GDMA_ChannelNum, uint8_t osw_count)
{
    ...
    GDMA_DmaOsNum_t gdma_0x3b8 = {.d32 = GDMAx->GDMA_DmaOsNum};
