 ...
 *                        Header Files
 *============================================================================*/
#include "keyscan/inc/rtl_keyscan.h"
...
void KeyScan_Init(KEYSCAN_TypeDef *KeyScan, KEYSCAN_InitTypeDef *KeyScan_InitStruct)
{
    ...
    KEYSCAN_CONFIG2_t keyscan_0x08 = {.d32 = KeyScan->KEYSCAN_CONFIG2};
    ...
    KEYSCAN_CLK_DIV_t keyscan_0x00 = {.d32 = KeyScan->KEYSCAN_CLK_DIV};
    KEYSCAN_CONFIG1_t keyscan_0x04 = {.d32 = KeyScan->KEYSCAN_CONFIG1};
    KEYSCAN_COLUMN_CONFIG_t keyscan_0x0c = {.d32 = KeyScan->KEYSCAN_COLUMN_CONFIG};
    KEYSCAN_ROW_CONFIG_t keyscan_0x10 = {.d32 = KeyScan->KEYSCAN_ROW_CONFIG};
...
{
    assert_param(IS_KeyScan_PERIPH(KeyScan));
    KEYSCAN_INT_STS_t keyscan_0x20 = {.d32 = KeyScan->KEYSCAN_INT_STS};
...
void KeyScan_ClearFlags(KEYSCAN_TypeDef *KeyScan, uint32_t KeyScan_FLAG)
{
    ...
    KEYSCAN_INT_CLR_t keyscan_0x1c = {.d32 = KeyScan->KEYSCAN_INT_CLR};
