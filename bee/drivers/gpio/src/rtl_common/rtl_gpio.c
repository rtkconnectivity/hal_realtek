...
void GPIO_StructInit(GPIO_InitTypeDef *GPIO_InitStruct)
{
    ...
    /**< Select debounce count clk source. */
    GPIO_InitStruct->GPIO_DebounceClkSource = GPIO_DEBOUNCE_S11;
    /**< Select debounce count clk divider. */
    GPIO_InitStruct->GPIO_DebounceClkDiv = GPIO_DEBOUNCE_DIVIDER_1;
    /* debounce time=(CNT_LIMIT+1)*DEB_CLK*/
