...
void ADC_DLPSEnter(void *PeriReg, void *StoreBuf)
{
    ...
    store_buf->adc_reg[5]         =  ADC->ADC_ANALOG_CTRL;      //0x58
    store_buf->adc_reg[6]         =  ADC->ADC_TIME_PERIOD;      //0x5C
...
void ADC_DLPSExit(void *PeriReg, void *StoreBuf)
{
    ...
    *(__IO uint32_t *)((uint32_t *)(&ADC->ADC_SCHTAB14))  = store_buf->adc_schtab_reg[14] |
    ...
    ADC->ADC_ANALOG_CTRL    = store_buf->adc_reg[5];
    ADC->ADC_TIME_PERIOD    = store_buf->adc_reg[6];
