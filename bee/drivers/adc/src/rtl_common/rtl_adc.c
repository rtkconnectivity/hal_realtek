...
void ADC_Init(ADC_TypeDef *ADCx, ADC_InitTypeDef *ADC_InitStruct)
{
    ...
    ADC_DIG_CTRL_t adc_0x04 = {.d32 = ADCx->ADC_DIG_CTRL};
    ADC_SCHED_CTRL_t adc_0x08 = {.d32 = ADCx->ADC_SCHED_CTRL};
    ADC_POW_DATA_DLY_CTRL_t adc_0x50 = {.d32 = ADCx->ADC_POW_DATA_DLY_CTRL};
    ADC_DATA_CLK_CTRL_t adc_0x54 = {.d32 = ADCx->ADC_DATA_CLK_CTRL};
    ADC_TIME_PERIOD_t adc_0x5C = {.d32 = ADCx->ADC_TIME_PERIOD};
    ...
    {
        *(__IO uint32_t *)((uint32_t *)(&ADCx->ADC_SCHTAB0) + index) = (ADC_InitStruct->ADC_SchIndex[index *
                                                                              2] | \
    ...
    {
        *(__IO uint32_t *)((uint32_t *)(&ADCx->ADC_SCHTABD16) + index) = (ADC_InitStruct->ADC_SchIndex[16 +
                                                                             index] << 16);
    }
#endif
    ...
    adc_0x04.b.adc_data_latch_edge = ADC_InitStruct->ADC_DataLatchEdge;
