...
*********************************************************************************************************
* \file      rtl876x_i2s.h
* \brief     header file of I2S driver.
* \details
* \author   elliot chen
* \date     2024-01-19
* \version   v1.0
...
/* Register: DSP_INT_CR -------------------------------------------------------*/
/* Description: Interrupt clear register. Offset: 0x0C. */
...
typedef struct
{
    uint32_t I2S_ClockSource;           /*!< Specify the I2S clock source.
    ...
    uint32_t I2S_DeviceMode;            /*!< Specify the I2S device mode.
                                        This parameter can be a value of \ref I2S_device_mode. */
    uint32_t I2S_ChannelType;           /*!< Specify the channel type used for the I2S communication.
                                        This parameter can be a value of \ref I2S_Channel_Type. */
    uint32_t I2S_TxChSequence;          /*!< Specify the transmission channel sequence used for the I2S communication.
                                        This parameter can be a value of \ref I2S_Tx_Ch_Sequence. */
    uint32_t I2S_RxChSequence;          /*!< Specify the receiving channel sequence used for the I2S communication.
                                        This parameter can be a value of \ref I2S_Rx_Ch_Sequence. */
    uint32_t I2S_DataFormat;            /*!< Specify the I2S data format mode.
                                        This parameter can be a value of \ref I2S_Format_Mode.*/
    uint32_t I2S_TxBitSequence;         /*!< Specify the I2S data bits sequences.
                                        This parameter can be a value of \ref I2S_Tx_Bit_Sequence.*/
    uint32_t I2S_RxBitSequence;         /*!< Specify the I2S data bits sequences.
                                        This parameter can be a value of \ref I2S_Rx_Bit_Sequence.*/
    uint32_t I2S_DataWidth;             /*!< Specify the I2S data width.
                                        This parameter can be a value of \ref I2S_Data_Width. */
    uint32_t I2S_MCLKOutput;            /*!< Specify the I2S MCLK output frequency.
                                        This parameter can be a value of \ref I2S_MCLK_Output. */
    uint32_t I2S_DMACmd;                 /*!< Specify the I2S DMA control.
...
/**
 * \defgroup    I2S_Clear_Interrupts_Definition I2S Clear Interrupts Definition
 * \{
 * \ingroup     I2S_Exported_Constants
 */
 ...
 * \param[in]  I2S_InitStruct: pointer to an I2S_InitTypeDef structure that
 ...
 * \param[in]  I2S_INT: Specify the I2S interrupt sources to be enable or disable.
 *   This parameter can be the following values:
 ...
 * \param[in]  NewState: new state of the specified I2S interrupts.
 *   This parameter can be: ENABLE or DISABLE.
 * \return None.
 *
 * <b>Example usage</b>
 ...
 * This parameter can be one of the following values, which refers to \ref I2S_Interrupts_Definition.
 *     \arg I2S_INT_TX_IDLE: Transmit idle interrupt.
 *     \arg I2S_INT_RF_EMPTY: Receive FIFO empty interrupt.
 *     \arg I2S_INT_TF_EMPTY: Transmit FIFO empty interrupt.
 *     \arg I2S_INT_RF_FULL: Receive FIFO full interrupt.
 ...
 *     \arg I2S_INT_RX_READY: Ready to receive interrupt.
 *     \arg I2S_INT_TX_READY: Ready to transmit interrupt.
 * \return The new state of I2S_FLAG (SET or RESET).
 *
 * <b>Example usage</b>
 * \code{.c}
 *
...
/**
 * \brief  Clear the I2S interrupt pending bits.
 * \param[in]  I2S_CLEAR_INT: Specify the interrupt pending bit to clear.
 *   This parameter can be any combination of the following values, which refers to \ref I2S_Clear_Interrupts_Definition.
...
/**
 * \brief  Transmit data through the SPIx/I2Sx peripheral.
...
/**
 * \brief  Return the most recent received data by the I2Sx peripheral.
...
/**
 * \brief  Return the transmit FIFO free length of the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
 * \brief  Return the receive FIFO data length of the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
 * \brief  Return the send error counter value of the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
 * \brief  Return the reception error counter value of the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
 * \brief   Swap audio data byte sequence sent by the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \param[in]  NewState: New state of the byte sequence.
 *   This parameter can be: ENABLE or DISABLE.
 * \return None.
 *
 * <b>Example usage</b>
...
/**
 * \brief  Swap audio data byte sequence read by the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \param[in]  NewState: New state of the byte sequence.
 *   This parameter can be: ENABLE or DISABLE.
 * \return None.
...
/**
 * \brief  Swap audio channel data sent by the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
 * \brief Swap audio channel data read by the I2Sx peripheral.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \param[in]  NewState: New state of the left and right channel data sequence.
 *   This parameter can be: ENABLE or DISABLE.
 * \return None.
...
/**
 * \brief MCLK output selection, only I2S0 can be selected.
 * \param[in]  I2Sx: To select I2Sx peripheral, only I2S0 can be selected.
...
/**
 * \brief Update BClk clock parameter.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \param[in]  I2S_BClockMi: Mi parameter.
 * \param[in]  I2S_BClockNi: Ni parameter.
 * \return  Execution status: SET: success, RESET: failure.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \return Execution status: SET: BLCK is updating, RESET: BLCK update is done.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
...
/**
 * \brief Configure Channel parameter.
 * \param[in]  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
 * \param[in]  I2S_ChannelType: The channel type used for the I2S communication.
 *      This parameter can be one of the following values, which refers to \ref I2S_Channel_Type.
