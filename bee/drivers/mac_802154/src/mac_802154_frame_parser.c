...
static uint8_t security_offset_get(const uint8_t *p_frame)
{
    ...
    if (src_addr_is_present(p_frame))
    {
        if ((src_addr_size == MAC_802154_FRAME_PARSER_INVALID_OFFSET) ||
            (src_addr_offset == MAC_802154_FRAME_PARSER_INVALID_OFFSET))
        {
            return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
        }
    ...
    {
        if (src_panid_offset == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
        }
    ...
    {
        if (dst_addr_size == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
        }
...
static uint8_t ie_offset_get(const uint8_t *p_frame)
{
    ...
    {
        if (security_offset == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
        }
    ...
    {
        if (key_id_offset == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
        }
...
uint8_t mac_802154_frame_parser_src_panid_offset_get(const uint8_t *p_frame)
{
    ...
    {
        return mac_802154_frame_parser_dst_panid_offset_get(p_frame);
    }
    else
    {
        return 0;
...
uint8_t mac_802154_frame_parser_key_id_offset_get(const uint8_t *p_frame)
{
    ...
    if (MAC_802154_FRAME_PARSER_INVALID_OFFSET == sec_ctrl_offset)
    {
        return MAC_802154_FRAME_PARSER_INVALID_OFFSET;
    }
                                                    ...
                                                    bool           *p_dst_addr_extended)
{
    ...
    if ((0 == dst_addr_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == dst_addr_offset))
    {
    ...
    {
        *p_dst_addr_extended = mac_802154_frame_parser_dst_addr_is_extended(p_frame);
...
const uint8_t *mac_802154_frame_parser_dst_panid_get(const uint8_t *p_frame)
{
    ...
    return ((0 == dst_panid_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == dst_panid_offset))
...
const uint8_t *mac_802154_frame_parser_src_panid_get(const uint8_t *p_frame)
{
    ...
    return ((0 == src_panid_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == src_panid_offset))
                                                    ...
                                                    bool           *p_src_addr_extended)
{
    ...
    if ((0 == src_addr_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == src_addr_offset))
    {
    ...
    {
        *p_src_addr_extended = mac_802154_frame_parser_src_addr_is_extended(p_frame);
                                       ...
                                       mac_802154_frame_parser_mhr_data_t *p_fields)
{
    ...
    if (dst_addr_is_present(p_frame))
    {
        ...
        if (p_fields->dst_addr_size == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return false;
        }
    }
    ...
    if (src_addr_is_present(p_frame))
    {
        ...
        if (p_fields->src_addr_size == MAC_802154_FRAME_PARSER_INVALID_OFFSET)
        {
            return false;
        }
    }
...
const uint8_t *mac_802154_frame_parser_sec_ctrl_get(const uint8_t *p_frame)
{
    ...
    return ((0 == sec_ctrl_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == sec_ctrl_offset)) ?
...
const uint8_t *mac_802154_frame_parser_key_id_get(const uint8_t *p_frame)
{
    ...
    return ((0 == key_id_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == key_id_offset)) ?
...
const uint8_t *mac_802154_frame_parser_ie_header_get(const uint8_t *p_frame)
{
    ...
    if ((0 == ie_header_offset) || (MAC_802154_FRAME_PARSER_INVALID_OFFSET == ie_header_offset))
    {
        return NULL;
    }
