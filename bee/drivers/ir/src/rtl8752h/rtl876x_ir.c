...
/**
  ...
  *     @arg IR_INT_TF_OF: When TX FIFO is full, data continues to be wrote to TX FIFO, TX FIFO Over interrupt will be triggered.
  ...
  *     @arg IR_INT_RX_CNT_OF: When RX counter is overflow, RX counter overflow interrupt will be triggered.
  *     @arg IR_INT_RF_OF: When RX FIFO is full and continue to be wrote, RX FIFO overflow interrupt will be triggered.
  *     @arg IR_INT_RX_CNT_THR: When RX counter >= IR_RX_CNT_THR, RX Counter Threshold Interrupt will be triggered.
  *     @arg IR_INT_RF_ERROR: When RX FIFO is empty and continue to be read, RX FIFO error read interrupt will be triggered.
