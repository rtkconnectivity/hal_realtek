...
void UART_Init(UART_TypeDef *UARTx, UART_InitTypeDef *UART_InitStruct)
{
    ...
    /* Clear DLAB bit*/
    UART_LCR_t uart_0x0c = {.d32 = UARTx->UART_LCR};
    ...
    UART_CTRL0_t uart_0x10 = {.d32 = UARTx->UART_CTRL0};
    ...
    if (UART_InitStruct->UART_DmaEn == UART_DMA_ENABLE)
    {
        ...
        UART_MISCR_t uart_0x28 = {.d32 = UARTx->UART_MISCR};
