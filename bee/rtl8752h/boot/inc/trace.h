 ...
 *                         Types
 *============================================================================*/
/** @defgroup TRACE_Exported_Types Trace Exported Types
  * @brief
  * @{
  */
...
/**
 * \cond        Private
 * \brief       Internal functions and macros.
 * \defgroup    TRACE_Internal_Functions trace internal functions.
 * \{
 */
 ...
 * \}
 * \endcond
 */   /* End of group TRACE_Internal_Functions */

/*============================================================================*
 *                         Variables
 *============================================================================*/
/** @defgroup TRACE_Exported_Variables Trace Exported Variables
  * @brief
  * @{
  */
...
/** End of TRACE_Exported_Variables
  * @}
  */
...
#define TRACE_BDADDR(bd_addr)   \
    trace_bdaddr(COMBINE_TRACE_INFO(LOG_TYPE, SUBTYPE_BDADDR, 0, 0), (char *)(bd_addr))
...
#define TRACE_BINARY(length, data)  \
    trace_binary(COMBINE_TRACE_INFO(LOG_TYPE, SUBTYPE_BINARY, 0, 0), length, (uint8_t *)(data))
/**@}*/
